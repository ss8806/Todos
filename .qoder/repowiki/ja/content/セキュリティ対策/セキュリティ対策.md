...
## 更新要旨
**変更内容**
- 削除されたrate_limit_config.goファイルの参照を削除
- レート制限設定の実装を現在のconfig.pyの設定に合わせて更新
...
- [backend/app/core/limiter.py:1-9](file://backend/app/core/limiter.py#L1-L9)
...
- [backend/app/api/api_v1/endpoints/auth.py:1-133](file://backend/app/api/api_v1/endpoints/auth.py#L1-L133)
...
- Rate Limiting
  ...
  - 設定はconfig.pyのSettingsクラスで管理、環境変数から上書き可能
- エラーハンドリング
...
**節の出典**
- [backend/app/core/security.py:1-35](file://backend/app/core/security.py#L1-L35)
- [backend/app/core/config.py:52-68](file://backend/app/core/config.py#L52-L68)
- [backend/app/schemas/auth.py:1-11](file://backend/app/schemas/auth.py#L1-L11)
- [backend/app/schemas/user.py:1-13](file://backend/app/schemas/user.py#L1-L13)
- [backend/app/core/limiter.py:1-9](file://backend/app/core/limiter.py#L1-L9)
- [backend/app/middleware/error_handler.py:1-135](file://backend/app/middleware/error_handler.py#L1-L135)
...
**図の出典**
- [backend/app/api/api_v1/endpoints/auth.py:48-66](file://backend/app/api/api_v1/endpoints/auth.py#L48-L66)
- [backend/app/core/security.py:17-34](file://backend/app/core/security.py#L17-L34)
- [backend/app/core/config.py:52-54](file://backend/app/core/config.py#L52-L54)
...
- [backend/app/api/api_v1/endpoints/auth.py:124](file://backend/app/api/api_v1/endpoints/auth.py#L124)
...
- [backend/app/schemas/user.py:1-13](file://backend/app/schemas/user.py#L1-L13)
- [backend/app/schemas/auth.py:1-11](file://backend/app/schemas/auth.py#L1-L11)
- [backend/app/middleware/error_handler.py:13-42](file://backend/app/middleware/error_handler.py#L13-L42)
- [backend/app/api/api_v1/endpoints/auth.py:28-38](file://backend/app/api/api_v1/endpoints/auth.py#L28-L38)
...
- 設定
  - config.pyのSettingsクラスで管理、環境変数から上書き可能
  - RATE_LIMIT_DEFAULT、RATE_LIMIT_LOGIN、RATE_LIMIT_REGISTER、RATE_LIMIT_FORGOT_PASSWORD、RATE_LIMIT_RESET_PASSWORD
- 429エラー時のレスポンス
...
**図の出典**
- [backend/app/core/limiter.py:1-9](file://backend/app/core/limiter.py#L1-L9)
- [backend/app/core/config.py:63-68](file://backend/app/core/config.py#L63-L68)
- [backend/app/middleware/error_handler.py:112-134](file://backend/app/middleware/error_handler.py#L112-L134)
- [backend/app/api/api_v1/endpoints/auth.py:27](file://backend/app/api/api_v1/endpoints/auth.py#L27)
- [backend/app/api/api_v1/endpoints/auth.py:47](file://backend/app/api/api_v1/endpoints/auth.py#L47)
- [backend/app/api/api_v1/endpoints/auth.py:75](file://backend/app/api/api_v1/endpoints/auth.py#L75)
- [backend/app/api/api_v1/endpoints/auth.py:101](file://backend/app/api/api_v1/endpoints/auth.py#L101)
...
**図の出典**
- [backend/app/middleware/error_handler.py:13-134](file://backend/app/middleware/error_handler.py#L13-L134)
...
**図の出典**
- [backend/app/api/api_v1/endpoints/auth.py:69-133](file://backend/app/api/api_v1/endpoints/auth.py#L69-L133)
- [backend/app/crud/crud_user.py:1-28](file://backend/app/crud/crud_user.py#L1-L28)
- [backend/app/crud/crud_password_reset.py:1-56](file://backend/app/crud/crud_password_reset.py#L1-L56)
- [backend/app/core/security.py:10-14](file://backend/app/core/security.py#L10-L14)
...
- [backend/app/api/api_v1/endpoints/auth.py:53-61](file://backend/app/api/api_v1/endpoints/auth.py#L53-L61)
