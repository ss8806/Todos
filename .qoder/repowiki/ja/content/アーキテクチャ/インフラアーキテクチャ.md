...
## 更新概要
**変更内容**
- CI/CDパイプラインの強化：GitHub Actionsワークフローの分離とCodecov統合
- テストジョブの分離：バックエンドとフロントエンドのテストジョブを独立して実行
- コード品質監視：Codecovによるカバレッジレポートの自動アップロード
- Dockerイメージビルドの統合：Dockerイメージのビルドテストジョブの追加
...
**更新** GitHub Actionsワークフローの変更により、CI/CDパイプラインが強化され、フロントエンドとバックエンドのテストジョブが分離され、Codecovによるコード品質監視が導入されました。
...
**更新** CI/CDパイプラインが強化され、フロントエンドとバックエンドのテストジョブが分離され、Codecovによるコード品質監視が導入されました。
